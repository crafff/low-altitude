...
| BlueSky1.1.1垂向VS差的1.524阈值没有乘dt，近目标直接赋VS；它不是统一的1.524m/s²有限差分界 | 水平TAS、航向和垂向分别按实际分支建立界；连续模型须明示假设，高度捕获/舍入另证 | [原生更新审计与公式(20)](CONTAINMENT_DERIVATION.md)；无新模拟，不称已证明高度不变性 |
