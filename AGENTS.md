...
- At the start of new implementation or diagnosis, retrieve relevant LESSONS/SOURCES entries with a targeted search and apply the applicable evidence. Record confirmed new knowledge or corrections where they belong; do not turn every routine step into a lesson.
